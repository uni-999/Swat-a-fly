...
- 2026-02: Online net-sim hotfix: в `match-server` включён автогаз для игроков и разрешён старт заезда даже при 1 участнике, чтобы убрать зависание без движения при проблемах ready-flow/второго клиента.
