...
| `CACTUS` | Кактус | Травяной зелёный | Объект: `radius=11` | `-1` сегмент тела | Мгновенно |
...
- Горизонтальное «ползание» заголовка дополнительно замедлено примерно в `10x`, чтобы он не пробегал экран много раз за один заезд.
