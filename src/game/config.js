...
export const NPC_EDGE_CAUTION_START_RATIO = 0.54;
export const NPC_EDGE_AVOID_LOOKAHEAD = 0.026;
...
export const OUTSIDE_EXTRA_SLOWDOWN = 0.38;
...
export const RACE_RULES_SPLASH_MS = 2000;
export const RACE_RULES_SPLASH_TEXT = "ЦЕЛЬ: ПРОЙТИ 3 КРУГА НА МАКСИМАЛЬНОЙ СКОРОСТИ";
